...
from check_containment_system import validate_containment_test
...
def validate(path, profile="seed"):
    require(profile in {"seed", "terminal", "isolation", "boot-test", "admin-test", "interactive", "lifecycle-test", "containment-test"}, "unknown system profile")
    if profile == "containment-test":
        validate_containment_test(ET.parse(path).getroot())
        return
...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile", choices=("seed", "terminal", "isolation", "boot-test", "admin-test", "interactive", "lifecycle-test", "containment-test"), default="seed")
